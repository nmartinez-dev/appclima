        ...
        return (
            <div id='modalScreen'>
                <div id='modalCard'>
                    ...
                    <div id='details'>
                        <div id='data'>
                            <div> Sensación Térmica: {cityWeather.feels_like} °C </div>
                            <div> Temperatura Mínima: {cityWeather.temp_min} °C </div>
                            <div> Temperatura Máxima: {cityWeather.temp_max} °C </div>
                        </div>

                        <div id='data'>
                            <div> Viento: {cityWeather.windSpeed} km/h </div>
                            <div> Presión: {cityWeather.pressure} hPa </div>
                            <div> Visibilidad: {cityWeather.visibility} km </div>
                        </div>
                    </div>
                </div>
            </div>
